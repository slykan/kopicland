<form wire:submit="search" class="grid gap-3 rounded-2xl bg-white p-4 text-brand-900 shadow-lg sm:grid-cols-2 lg:grid-cols-6 lg:items-end">
    <div class="lg:col-span-2">
        ...
        <input type="text" inputmode="numeric" placeholder="dd.mm.gggg" pattern="\d{2}\.\d{2}\.\d{4}" wire:model="checkIn" class="mt-1 w-full rounded-lg border border-brand-200 px-3 py-2 text-sm text-brand-900 focus:border-brand-500 focus:ring-brand-500">
    ...
    <div class="lg:col-span-2">
        ...
        <input type="text" inputmode="numeric" placeholder="dd.mm.gggg" pattern="\d{2}\.\d{2}\.\d{4}" wire:model="checkOut" class="mt-1 w-full rounded-lg border border-brand-200 px-3 py-2 text-sm text-brand-900 focus:border-brand-500 focus:ring-brand-500">
